...
function router() {
  ...
  try {
    ...
    if (typeof lucide !== 'undefined') {
      lucide.createIcons(); // Instantly compile dynamic Lucide Icons
    }
  } catch (error) {
...
function renderHome() {
  ...
  let packagesHTML = '';
  lots.forEach(lot => {
    const compatibleDesigns = db.getDesigns().filter(d => lot.compatible_design_ids.includes(d.id));
      ...
      packagesHTML += `
        <div class="market-card">
          <div class="card-img-wrapper">
            ...
            <img src="${lot.image_urls[0]}" class="card-img" alt="${lot.title}">
          </div>
  ...
  viewport.innerHTML = `
    ...
    <section class="hero">
      <div class="container hero-grid">
        <div>
          <h1 class="hero-title">From Lot to Home, <br><span>Made Simple.</span></h1>
          <p class="hero-subtitle">
            Browse compatible lots, choose an award-winning modern design, select your finish packages, and start your build with transparent guided milestones.
          </p>
        ...
        <div class="hero-visual">
          <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=80" class="hero-img" alt="Modern Architecture home">
          <div class="hero-overlay-card">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.35rem;">
              <span class="badge badge-gold">Featured Model</span>
              <span style="font-weight:700; color:var(--color-accent-sage-dark);">Active Build</span>
            </div>
            <p style="font-size:0.95rem; font-weight:700; color:var(--color-brand-primary);">The Essential + Ocean View Lot</p>
            <p style="font-size:0.8rem; color:var(--color-text-secondary);">Currently building stage: Bank Draw Stage 3 (Framing completion)</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section-padding bg-light">
      <div class="container">
        <div class="text-center mb-6">
          ...
          <h2 class="mb-2">How Lots2Homes Works</h2>
          <p class="text-secondary" style="max-width: 600px; margin: 0 auto;">
            We eliminate the standard uncertainty, delays, and surprise invoices associated with building custom homes.
          </p>
        </div>
      ...
      html += `
        <div class="market-card">
          ...
          <div class="card-content">
            ...
            <div class="card-specs">
              <span class="spec-item"><i data-lucide="maximize"></i> ${lot.lot_size} ${lot.lot_size_unit}</span>
              <span class="spec-item"><i data-lucide="activity"></i> ${lot.compatible_design_ids.length} compatible layouts</span>
            </div>
            <div class="card-cta">
...
function renderLotDetail(lotId) {
  ...
  let thumbnailsHTML = '';
  lot.image_urls.forEach((url, index) => {
    thumbnailsHTML += `
        ...
        <div class="detail-grid">
          ...
          <div>
            ...
            <div class="gallery-main">
              <img src="${lot.image_urls[0]}" id="main-detail-gallery" alt="${lot.title}">
            </div>
...
function renderDesignDetail(designId) {
  ...
  const compatibleLots = db.getLots().filter(lot => lot.compatible_design_ids.includes(design.id));
  ...
  function updateFinishPackageDetails(pkgId) {
    ...
    fpMaterials.innerHTML = pkg.included_materials.map(m => `<li>${m}</li>`).join('');
  }
  ...
  viewport.innerHTML = `
    ...
    <section class="section-padding" style="padding-bottom:2rem;">
      <div class="container text-center">
        <span class="badge badge-gold mb-1">Workflow Guide</span>
        <h1 style="font-size:2.8rem; margin-bottom:0.5rem;">The Guided Building Process</h1>
        <p class="text-secondary" style="max-width: 650px; margin:0 auto; font-size:1.1rem;">
          Lots2Homes unifies property purchase, architecture plans, interior selections, and local builders under a single, fully-managed milestone track.
        </p>
      </div>
    </section>
...
function renderFAQ() {
  viewport.innerHTML = `
    <section class="section-padding bg-light">
      <div class="container">
        <div class="text-center mb-6">
          <span class="badge badge-gold mb-1">Knowledge Hub</span>
          <h1 style="font-size:2.8rem; margin-bottom:0.5rem;">Frequently Asked Questions</h1>
          <p class="text-secondary" style="max-width: 600px; margin: 0 auto; font-size:1.05rem;">
            Find quick, transparent answers to zoning questions, option fee details, and structural progress draw mechanics.
          </p>
        </div>
    ...
    <section class="section-padding">
      <div class="container" style="max-width: 600px;">
        <div class="text-center mb-6">
          ...
          <h1 style="font-size:2.8rem; margin-bottom:0.5rem;">Contact Our Team</h1>
          <p class="text-secondary">Have general questions? Reach out directly and we will assist you.</p>
        </div>
            ...
            <div class="form-group col-span-2 mb-4">
              ...
              <div style="display:grid; grid-template-columns: repeat(2, 1fr); gap:0.5rem; margin-top:0.25rem;" id="wizard-upgrades-checklist">
                ${upgrades.map(up => {
                  ...
                  return `
                    <label class="checkbox-group" style="padding:0.5rem; border:1px solid var(--color-border-glass); border-radius:6px; background:#ffffff;">
                      <input type="checkbox" name="upgrades" value="${up.id}" ${isChecked ? 'checked' : ''}>
                      <div>
                        <div style="font-weight:700; font-size:0.85rem;">${up.name}</div>
...
function renderAdmin() {
  ...
  viewport.innerHTML = `
    <div class="admin-shell">
      ...
      <aside class="admin-sidebar">
        ...
        <ul class="admin-menu">
          <li class="admin-menu-item active" data-tab="overview"><button><i data-lucide="layout-dashboard"></i> <span>Overview</span></button></li>
          <li class="admin-menu-item" data-tab="lots"><button><i data-lucide="map"></i> <span>Lots Registry</span></button></li>
          <li class="admin-menu-item" data-tab="designs"><button><i data-lucide="home"></i> <span>Designs Catalog</span></button></li>
          <li class="admin-menu-item" data-tab="upgrades"><button><i data-lucide="sliders"></i> <span>Upgrades Matrix</span></button></li>
          <li class="admin-menu-item" data-tab="finishes"><button><i data-lucide="palette"></i> <span>Finish Packages</span></button></li>
          <li class="admin-menu-item" data-tab="leads"><button><i data-lucide="users"></i> <span>Buyer Leads</span></button></li>
          <li class="admin-menu-item" data-tab="landowners"><button><i data-lucide="landplot"></i> <span>Lot Submissions</span></button></li>
          <li class="admin-menu-item" data-tab="contractors"><button><i data-lucide="hammer"></i> <span>Contractors</span></button></li>
          <li class="admin-menu-item" data-tab="partners"><button><i data-lucide="handshake"></i> <span>Partner Apps</span></button></li>
        </ul>
  ...
  function compileAdminLots() {
    ...
    function compileLotsRows(list) {
      if (list.length === 0) return `<tr><td colspan="7" class="text-center text-muted">No lots registered in database.</td></tr>`;
      return list.map(lot => `
        <tr>
          ...
          <td><span class="badge ${lot.status === 'Available' ? 'badge-sage' : 'badge-gold'}">${lot.status}</span></td>
          <td>
  ...
  function openLotFormModal(lot = null) {
          ...
          <form id="modal-lot-form">
            <div class="modal-body">
              ...
              <div class="form-grid">
                ...
                <div class="form-group">
                  <label class="form-label">Image Reference URL (Unsplash/Base64)</label>
                  <input type="text" class="form-input" name="image_url" value="${lot ? lot.image_urls[0] : ''}">
                </div>
                ...
                <div class="form-group col-span-2">
                  ...
                  <div style="display:grid; grid-template-columns: repeat(3, 1fr); gap:0.5rem; margin-top:0.25rem;">
                    ${designs.map(d => {
                      const isChecked = lot ? lot.compatible_design_ids.includes(d.id) : false;
    ...
    document.getElementById('modal-lot-form').addEventListener('submit', (e) => {
      ...
      const updatedLot = {
        ...
        image_urls: formData.get('image_url') ? [formData.get('image_url')] : undefined,
  ...
  function compileAdminDesigns() {
    ...
    function compileDesignsRows(list) {
      if (list.length === 0) return `<tr><td colspan="6" class="text-center text-muted">No design models preloaded.</td></tr>`;
      return list.map(ds => `
        <tr>
            ...
            <div class="modal-body">
              ...
              <div class="form-grid">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-input" name="image_url" value="${design ? design.image_urls[0] : ''}">
                </div>
                <div class="form-group">
          ...
          <form id="modal-upgrade-form">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-textarea" name="description" required style="min-height:90px;">${upgrade ? upgrade.description : ''}</textarea>
              </div>
            </div>
            <div class="modal-footer">
  ...
  function compileAdminFinishes() {
    ...
    document.getElementById('btn-admin-add-finish').addEventListener('click', () => {
      showToast('MVP Limitation', 'Creating finish packages is locked in the MVP prototype. Use seed presets.', 'error');
    });
  }
  ...
  function compileAdminLandowners() {
    ...
    function compileLandownerRows(list) {
      if (list.length === 0) return `<tr><td colspan="7" class="text-center text-muted">No landowner proposals logged.</td></tr>`;
